...
<br></br>
  ...
  <div className="row no-gutters">
    <div className="col-md-4">
      <img src="https://media.pff.com/2020/04/Alvin-Kamara.jpg?w=956&h=538" className="card-img" alt="..."/>
    </div>
  ...
  <div className="row no-gutters">
    <div className="col-md-4">
      <img src="https://thefalconswire.usatoday.com/wp-content/uploads/sites/56/2020/08/USATSI_14808191.jpg?w=1000&h=600&crop=1" className="card-img" alt="..."/>
    </div>
    <div className="col-md-8">
      <div className="card-body">
        <p className="card-text">Matchup Preview + Week 5 Injury Analysis with Dr. Seuss</p>
  ...
  <div className="row no-gutters">
    <div className="col-md-4">
      <img src="https://sportsnaut.com/wp-content/uploads/2021/04/sean-mcvay-goff-scaled.jpg" className="card-img" alt="..."/>
    </div>
    <div className="col-md-8">
      <div className="card-body">
  ...
  <div className="row no-gutters">
    <div className="col-md-4">
      <img src="https://ftw.usatoday.com/wp-content/uploads/sites/90/2021/03/AP-Playing-Tag-Football-e1615301675646.jpg?w=1000&h=600&crop=1" className="card-img" alt="..."/>
    </div>
    <div className="col-md-8">
      <div className="card-body">
        {/* <h5 className="card-title">Card title</h5> */}
  ...
  <div className="row no-gutters">
    <div className="col-md-4">
      <img src="https://bostonglobe-prod.cdn.arcpublishing.com/resizer/LQ4Nn1YoOny-u6sqjvJDA5roGYA=/1440x0/cloudfront-us-east-1.images.arcpublishing.com/bostonglobe/6LZWSVWETXMTGKEGVL52TNNB7U.jpg" className="card-img" alt="..."/>
    </div>
    <div className="col-md-8">
      <div className="card-body">
        {/* <h5 className="card-title">Card title</h5> */}
